...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'description' => [
            'max' => 'La description ne peut pas dépasser 2000 caractères.',
        ],
        'pages' => [
            'integer' => 'Le nombre de pages doit être un entier.',
            'min' => 'Le nombre de pages doit être au moins 1.',
            'max' => 'Le nombre de pages ne peut pas dépasser 10000.',
        ],
        'language' => [
            'required' => 'La langue est requise.',
            'string' => 'La langue doit être une chaîne de caractères.',
            'max' => 'La langue ne peut pas dépasser 10 caractères.',
        ],
        'author_id' => [
            'required' => 'L\'auteur est requis.',
            'exists' => 'L\'auteur sélectionné n\'existe pas.',
        ],
    ],
